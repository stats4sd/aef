...
<html lang="en">
    ...
    <body>
        ...
        <button id="scrollToTopButton" class="hidden fixed bottom-5 right-5 w-12 h-12 bg-dark-teal text-white rounded-full shadow-lg flex items-center justify-center transition-opacity duration-300 hover:bg-teal">
